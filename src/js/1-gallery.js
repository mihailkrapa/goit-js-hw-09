...
lightbox.on('shown.simplelightbox', function () {
  setTimeout(function () {
    let captionElement = document.querySelector('.sl-image');
    let imageElement = captionElement.querySelector('img');
    captionElement.insertAdjacentHTML('beforeend', imageElement.alt);
  }, 250);
});